...
- [ ] Explain what a token is used for.
  ...
  **Answer:** A token is used to authenticate a user to access pages that are protected.

- [ ] What steps can you take in your web apps to keep your data secure?

  **Answer:** Hide pages behind private routes, accessing data that can only be accessed by authorized users, etc.

- [ ] Describe how web servers work.

  **Answer:** Web Servers are basically simple computer programs that dispense the web page when they are requested using the web client
